...
if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗] 𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝚄𝙽 𝙴𝙽𝙻𝙰𝙲𝙴 𝙳𝙴 𝙶𝙸𝚃𝙷𝚄𝙱, 𝙴𝙹𝙴𝙼𝙿𝙻𝙾: ${usedPrefix + command} https://github.com/OFD.git*\n\n\n[❗𝐈𝐍𝐅𝐎❗]ENTER THE LINK OF THE GITHUB EXAMPLE ${usedPrefix + command} https://github.com/D.git*`
